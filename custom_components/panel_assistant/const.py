...
# The non-administrator user this integration created to sign an entry's panel in
# from the sidebar. Removing the entry removes that user and no other.
CONF_PANEL_USER_ID = "panel_user_id"
